     ...
     <body background="imagef.jpg" style="background-repeat:no repeat;background-size:100%">
        ...
        <form action="FacultyAccountUpdate" method="get">
            ...
            <tr style="font-size:160%" >
                <td style="color:black;">New Password</td><td><input type="Password" name="password"/></td>
            </tr>
            <tr style="font-size:160%" >
            ...
            <tr style="font-size:160%" >
                <td style="color:black;">email</td> <td><input type="text" name="email" style="font-size:60%"/></td>
            </tr>
            <tr style="font-size:160%" >
                <td style="color:black;">mobile</td> <td><input type="text" name="mobile" style="font-size:60%"/></td>
            </tr>
            <tr style="font-size:160%" >
             <td style="color:black;" >Post</td><td><select name="post" style="font-size:70%"><option >Professor</option><option>SubTeacher</option><option>H.O.D</option><option>Class-Coordinator</option></td>   
           
            </tr>
            <tr style="font-size:160%" >
                <td style="color:black;">Branch</td> <td><input type="text" name="branch" style="font-size:60%"/></td>
            </tr>
